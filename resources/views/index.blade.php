<x-app-layout>
    ...
    <div class="ideas-container space-y-6 my-6">
        <div class="idea-container hover:shadow-card transition duration-250 ease-in bg-white rounded-xl flex cursor-pointer">
            <div class="border-r border-gray-100 px-5 py-8">
                ...
                <div class="mt-8">
                    <button class="w-20 bg-slate-200 border border-slate-200 font-bold text-xxs uppercase rounded-xl px-4 py-3
                    hover:border-slate-500 transition duration-350 ease-in">Vote </button>
                </div>
            </div>
