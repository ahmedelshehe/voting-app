    ...
    <div class="ideas-container space-y-6 my-8">
        ...
        <div class="idea-container hover:shadow-card transition duration-150 ease-in bg-white rounded-xl flex cursor-pointer">
            <div class="hidden md:block border-r border-gray-100 px-5 py-8">
                ...
                <div class="mt-8">
                    <button class="w-20 bg-blue border border-blue hover:border-blue font-bold text-xxs text-white uppercase rounded-xl transition duration-150 ease-in px-4 py-3">Voted</button>
                </div>
            </div>
            <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
                <div class="flex-none mx-2 md:mx-0">
                ...
                <div class="w-full flex flex-col justify-between mx-2">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div class="flex items-center md:hidden mt-4 md:mt-0">
                            ...
                            <button
                                class="w-20 bg-blue border border-blue font-bold text-xxs uppercase rounded-xl hover:border-gray-400 transition duration-150 ease-in px-4 py-3 -mx-5"
                            >
                                Voted
                            </button>
                        </div>
                ...
                <div class="w-full flex flex-col justify-between mx-2">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div
                            ...
                            class="flex items-center space-x-2 mt-4 md:mt-0"
                        >
                            <div class="bg-green text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4">Finished</div>
                            <button
                                @click="isOpen = !isOpen"
                                class="relative bg-gray-100 hover:bg-gray-200 border rounded-full h-7 transition duration-150 ease-in py-2 px-3"
                            >
